      ...
      page.innerHTML = `
        ...
        <section class="role-panel">
          <div class="role-panel-heading">
            <div><div class="section-label">CONTENT STUDIO</div><h2>लेख प्रबंधन</h2></div>
          </div>
        ...
        <section class="role-panel">
          ...
          <p class="role-muted">यहाँ Firebase UID जोड़ने के बाद संबंधित account को Acharya role मिलेगा।</p>
